...
const ProjectDetails = ({translate}) => {
          ...
          <div className="max-w-screen-lg mx-auto w-full px-2 ">
            <div className="lg:flex lg:justify-center lg:space-x-12 mb-12">
              ...
              <motion.div initial="hidden" animate="visible" variants={list}>
                ...
                >
                 {translate === "en" ? "Descripción" : "Description:"} 
                </motion.h4>
                <motion.p
                  variants={item}
                  className="mb-6 text-lg text-gray-700 dark:text-gray-200 font-main font-medium"
                >
                   {translate === "en" ? project?.description.es : (project?.description.en)}
                ...
                <motion.h4
                  ...
                  className="mb-2 text-xl text-gray-900 dark:text-gray-300  font-main font-semibold"
                >
                  {translate === "en" ? "Herramientas" : "Tools:"} 
                </motion.h4>
                ...
                >
                  ...
                  >
                    <span>{translate === "en" ? "Visita la aplicación" : "Visit App:"}</span>
                  ...
                  <a
                    ...
                    className="mr-4 hover:text-primary flex  items-center  space-x-2"
                  >
                    <span>{translate === "en" ? "Ver fuente" : "View Source:"}</span>
